...
//                        (searched out to HW_MAX / 8 = 3 tiles - 49 fetches, at 1/64 of the pixels)
...
const float HW_MAX = 24.0;		// = K in rtshadow_blur.frag
const int   TILE_REACH = 3;		// HW_MAX / 8: how many tiles away the widest shadow still reaches
