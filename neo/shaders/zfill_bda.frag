// Phase 3.2b BDA consume: fragment stage for the manual-vertex-fetch depth fill.
// Identical to zfill.frag — the BDA variant only changes how the vertex is fetched,
// not the fragment behaviour (optional alpha test + color output).
