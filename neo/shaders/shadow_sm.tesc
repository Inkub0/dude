// DUDE tessellation (docs/tessellation.md): 2D shadow-map caster control shader.
// Same crack-free factor logic as zfill.tesc so a tessellated caster subdivides the
// same way the lit passes do; its cast shadow then matches the smoothed body.
