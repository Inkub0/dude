...
idCVar r_shadowMapPointSize( "r_shadowMapPointSize", "1024", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_INTEGER, "point-light cube shadow map resolution per face (6 faces); lower than the 2D map since faces cover more", 128, 4096 );
...
idCVar r_ssaoIntensity( "r_ssaoIntensity", "2.4", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_FLOAT, "SSAO strength: scales the occlusion darkening (0 = none, 2.4 = default, higher = deeper creases)", 0.0f, 4.0f );
...
idCVar r_ssaoSlices( "r_ssaoSlices", "6", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_INTEGER, "SSAO horizon-search directions (slices) per pixel; more = smoother, less directional noise, more GPU cost", 1, 8 );
idCVar r_ssaoSteps( "r_ssaoSteps", "1", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_INTEGER, "SSAO samples marched along each direction; more = more accurate horizons at range, more GPU cost", 1, 12 );
