...
idCVar r_ssrHiZLevel( "r_ssrHiZLevel", "2", CVAR_RENDERER | CVAR_INTEGER, "with r_ssrHiZ: coarse mip level the march leaps at (higher = bigger blocks / longer leaps but a coarser nearest-surface bound). Dev tuning knob for the A/B", 1, 5 );
