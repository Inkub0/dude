...
idCVar r_ssrGlassProbeScale( "r_ssrGlassProbeScale", "1.0", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_FLOAT, "brightness of the baked room probe on glass, on top of the stage colour and r_gl3ReflectionScale. Only applies while a probe is bound (bump-mapped glass ignores it — that shader takes no stage colour, matching vanilla)", 0.0f, 4.0f );
