...
#else
#define GAME_NAME						"DUDE"			// appears in errors
#endif

// DUDE - Doom3 Unified Development Engine (fork of dhewm3 1.5.5)
#define ENGINE_VERSION					"DUDE 0.9.3"	// printed in console, used for window title
