...
void idGameLocal::RegisterRenderInterpolation( idEntity *ent ) {
	...
	// gameLocal.time because the d3xp time groups run one tic under two clocks (fast/slow),
	// which would spuriously reset the list mid-tic once the clocks have diverged.
